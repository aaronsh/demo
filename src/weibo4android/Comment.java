...
public class Comment extends WeiboResponse implements java.io.Serializable {
    ...
    /*package*/Comment(Response res) throws WeiboException {
        ...
        try {
			...
			source = TextUtil.formatSource(json.getString("source"));
    ...
    /* modify by patrrr add if before get reply 09-12 23:31*/
    public Comment(JSONObject json)throws WeiboException, JSONException{
		...
		if(!json.isNull("reply_comment"))
			reply=new Status(json.getJSONObject("reply_comment"));
    }
    ...
    private void init(Response res, Element elem, Weibo weibo) throws
        ...
        source = TextUtil.formatSource(getChildText("source", elem));
    ...
    /**
     * Retrun the replyComent("reply_comment")
     * @return
     */
    public Status getreplay(){
    	return reply;
    }
