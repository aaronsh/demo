...
public class ArtSwitcher extends ViewSwitcher
{
    ...
    public ArtSwitcher(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
    
    public void setImageRotateBitmapResetBase(final RotateBitmap bitmap,
            final boolean resetSupp) {
    	ImageViewTouch image = (ImageViewTouch)this.getNextView();
        image.setImageRotateBitmapResetBase(bitmap, resetSupp);
        showNext();
    }
}
